<?php echo form_open('config/save_locale/', array('id' => 'locale_config_form', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
					<?php echo form_label($this->lang->line('config_lenght'),'config_lenght',array('class' => 'control-label col-xs-2'));?>
					<div class='col-xs-2'>
						<div class='input-group'>
						<span class="input-group-addon input-sm">1M = </span> 
						<?php echo form_input('lenght_yard', $this->config->item('lenght_yard'), array('class' => 'form-control input-sm'));?>
