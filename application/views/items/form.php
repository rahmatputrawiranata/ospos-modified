	...
	<fieldset id="item_basic_info">
		...
		<div class="form-group form-group-sm">
			...
			<div class="col-xs-8">
				...
				<input type="hidden" id="configu" name="configu" value="<?php echo $this->config->item('lenght_yard'); ?>"?>
		...
		?>
			<div class="form-group form-group-sm">
				...
				<span class="input-group-addon input-sm">M</span>
					</div>
				</div>
				<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<input type="text" name="yardq" id="yardq" class="required form-control input-sm"?>
		...
		<div class="form-group form-group-sm">
			...
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<input type="text" name="yardr" id="yardr" class="required form-control input-sm">
				<span class="input-group-addon input-sm">Y</span>
					</div>
				</div>
		</div>
...
<script type="text/javascript">
	...
	{
//quantity
		var lenghtinput = $('#<?php echo "quantity_".$key;?>').val() * $('#configu').val();

			$("#yardq").val(lenghtinput);

		$("#<?php echo 'quantity_'.$key;?>").keyup(function(){
			var lenghtinput = $('#<?php echo "quantity_".$key;?>').val() * $('#configu').val();
		...
		$("#yardq").keyup(function(){
			...
			$("#<?php echo 'quantity_'.$key;?>").val(lenghtinput);
		});

//receive quantity//

			var lenghtinput = $('#receiving_quantity').val() * $('#configu').val();

			$("#yardr").val(lenghtinput);

		$("#receiving_quantity").keyup(function(){
			var lenghtinput = $('#receiving_quantity').val() * $('#configu').val();
		...
		$("#yardr").keyup(function(){
			...
			$("#receiving_quantity").val(lenghtinput);
		});
